...
gen pago_frec_voluntario_nofee=inlist(producto,7) if inlist(producto,6,7)
...
reg logit_pred i.pago_frec_voluntario_nofee, r
reg boost_pred i.pago_frec_voluntario_nofee, r
