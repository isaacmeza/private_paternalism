...
twoway (hist apr if def_c==1 & apr<10 & t_prod==1, w(.1) percent lwidth(medthick) lcolor(navy) color(ltblue)) ///
	(hist apr if des_c==1 & t_prod==1, w(.1) percent lwidth(medthick) lcolor(black) color(none)) , ///
