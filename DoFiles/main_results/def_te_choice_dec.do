...
local vrlist  def_c  def_120 pos_pay_default     
local vrlistnames "not recover" "not rec. | days<120" "not rec. | pay>0"   
...
foreach arm of varlist pro_4 pro_5 {
	...
	*Name of vars
	...
	esttab using "$directorio/Tables/reg_results/def_te_`arm'.csv", se r2 ${star} b(a2) ///
