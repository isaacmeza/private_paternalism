...
foreach var of varlist fc_te_cf {
	...
	twoway 	(line cwf_1 threshold, lpattern(dash) lwidth(medthick) lcolor(red)) ///
			(line cwf_h90_1 threshold, lpattern(dot) lwidth(medthick) lcolor(red)) ///
			(line cwf_l90_1 threshold, lpattern(dot) lwidth(medthick) lcolor(red)) ///
			(line cwf_0 threshold, lpattern(dash) lwidth(medthick) lcolor(navy)) ///
			(line cwf_h90_0 threshold, lpattern(dot) lwidth(medthick) lcolor(navy)) ///
			(line cwf_l90_0 threshold, lpattern(dot) lwidth(medthick) lcolor(navy)) ///
	...
	twoway 	(line cwp_1 threshold, lpattern(dash) lwidth(medthick) lcolor(red)) ///
			(line cwp_h90_1 threshold, lpattern(dot) lwidth(medthick) lcolor(red)) ///
			(line cwp_l90_1 threshold, lpattern(dot) lwidth(medthick) lcolor(red)) ///
			(line cwp_0 threshold, lpattern(dash) lwidth(medthick) lcolor(navy)) ///
			(line cwp_h90_0 threshold, lpattern(dot) lwidth(medthick) lcolor(navy)) ///
			(line cwp_l90_0 threshold, lpattern(dot) lwidth(medthick) lcolor(navy)) ///
