*Treatment effects main results (ROBUST)- (Table)
...
global dep_vars des_c log_fc_admin log_fc_admin_disc log_fc_survey   num_p  sum_porcp_c mn_p_c mn_pdisc_c dias_al_desempenyo
...
*************************
	esttab using "$directorio/Tables/reg_results/te_robuts_`arm'.csv", se r2 star(* 0.1 ** 0.05 *** 0.01) b(a2) ///
	scalars("DepVarMean DControl Mean") replace 
