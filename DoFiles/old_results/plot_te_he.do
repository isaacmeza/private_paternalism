args depvar treat vrlist vrlistnames
...
foreach var of varlist `vrlist' {
	 ...
	 reg tau_hat_oobpredictions `var' if !missing(`treat'), r
	local df = e(df_r)	
...
#delimit cr
restore
graph export "$directorio\Figuras\HE\he_int_`depvar'_`treat'.pdf", replace
