...
eststo clear
foreach var of varlist  fc_admin fc_survey fc_tc fc_survey_tc fc_fa apr apr_survey apr_tc apr_survey_tc apr_fa {
...
(fc_survey_tc_p, keep(3.t_producto) rename(3.t_producto = "FC (subj.) + travel cost") color(navy)  cismooth(color(navy) n(10))  offset(0.09)) ///
...
(apr_survey_tc_p, keep(3.t_producto) rename(3.t_producto = "APR (subj.) + travel cost") color(navy)  cismooth(color(navy) n(10))  offset(0.09)) ///
...
(fc_survey_tc_p, keep(5.t_producto) rename(5.t_producto = "FC (subj.) + travel cost") color(maroon)  cismooth(color(maroon) n(10))  offset(-0.09)) ///
...
(apr_survey_tc_p, keep(5.t_producto) rename(5.t_producto = "APR (subj.) + travel cost") color(maroon)  cismooth(color(maroon) n(10))  offset(-0.09)) ///
