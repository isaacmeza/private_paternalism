...
(fc_survey_tc_p, keep(2.t_producto) rename(2.t_producto = "FC (subj.) + travel cost") color(navy)  cismooth(color(navy) n(10))  offset(0.09)) ///
...
(apr_survey_tc_p, keep(2.t_producto) rename(2.t_producto = "APR (subj.) + travel cost") color(navy)  cismooth(color(navy) n(10))  offset(0.09)) ///
...
(fc_survey_tc_p, keep(4.t_producto) rename(4.t_producto = "FC (subj.) + travel cost") color(maroon)  cismooth(color(maroon) n(10))  offset(-0.09)) ///
...
(apr_survey_tc_p, keep(4.t_producto) rename(4.t_producto = "APR (subj.) + travel cost") color(maroon)  cismooth(color(maroon) n(10))  offset(-0.09)) ///
