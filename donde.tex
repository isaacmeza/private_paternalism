...
We begin our empirical analysis with a comparison of the Forced Commitment and Commitment Choice arms to the control.  Before presenting experimental ITT results, 
...
\begin{figure}[H]
    ...
    Finally, `APR - interests' is a version of the APR that doesn't include the interest that is mechanically saved by paying early since this is the piece of the Forced-commitment contract that has a foregone liquidity cost for the borrower. The treatment effects are indicated in standard deviations, together with 95\% confidence intervals.
\end{figure}
