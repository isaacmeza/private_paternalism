...
\begin{align}
        ...
        \label{eq:decomp}
\end{align}
where $\text{TUT}$ is the overall TUT effect and $\mathbbm{E}[Y_{1i} - Y_{0i}|C_i = 0, X_i = x]$ is the TUT conditional on $X_i = x$.    
