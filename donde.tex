...
\todo[inline]{Perhaps mention some other settings in which a design like this might be helpful? Need to think about this.}
...
\begin{figure}[H]
    ...
    \end{center}
    \scriptsize
   \hl{This is an outdated figure. Need to update}
