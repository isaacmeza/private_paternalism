...
Substantiating a case for private paternalism is not easy. It involves comparing the causal effect of forcing a certain product characteristic versus the effect of letting people choose it. This is not a straightforward task because choice will be driven by unobservable factors, and to address the question fully we would want a counterfactual for the outcome of both choosers and non-choosers. A large behavioral literature has illustrated that allowing borrowers or savers to choose commitment-style products increase savings in an Intention-to-Treat sense \citep{thaler2004save, prina2015banking, brune2016facilitating, callen2019headwaters, Pascaline, Ashraf}, but this literature has rarely inquired about the benefits of imposing commitment.\footnote{Selection on gains has such wide acceptance that economists often impose it in their models (for example, in the study of migration \cite{chiquiar2005international} and occupational choice \cite{heckman1990empirical}. In microfinance, a context close to ours, \citep{Murdoch} claims that positive selection exists, citing a positive correlation between displaying present biased preferences in surveys and selecting into microfinance as evidence of borrowers' actually demanding the discipline imposed by frequent payments.}   In this paper we illustrate how a three-armed, `controlled choice' design can be used to form counterfactuals for both choosers and non-choosers of commitment, providing a high-stakes and policy-relevant environment in which to test selection-on-gains as well as isolating the impact of paternalistic policies.
...
We start by bounding the distribution of individual treatment effects as in \cite{fan2010sharp} and find that at least 30\% of individual borrowers benefit from commitment, implying many borrowers did not demand even though the treatment effect would be positive for them. Then, we impose the twin exclusion restrictions necessary for estimation of the ToT and Tut (that the effect of choosing or not choosing is the same as being assigned or not assigned the contract).\footnote{This is a frequently used assumption even if often implicit. For instance, a significant literature uses schooling compulsory laws to estimate the return of one more year of school, and then often interprets that schooling, in general, has this return.}  With these assumptions, both treatment effects are point identified as well as the average selection on gains, average selection on levels, and average selection bias.  Our results indicate that while selection on gains are present in our sample, the financial cost savings of the TuT is still large (at \$356 pesos, it is equivalent to 24 percentage point savings in APR). Hence, on average borrowers that did \textit{not} choose the frequent payment contract would have benefited from having that contract.\footnote{While our estimated ToT is roughly twice the TuT, it is imprecisely estimated due to the low compliance rate, and the hypothesis of ToT=TuT is rejected only with 13 percent confidence for the APR and 12 percent confidence for default.}  We also estimate that those that would not choose if given the opportunity would have lower status-quo outcomes (i.e. the average selection bias is negative). Finally, assuming the exclusion restriction for subsets of observable characteristics splits generated by a causal forest allows us to establish that more than \hl{70\%} of would-be non-choosers would save on financial cost by being assigned to frequent payments. That is, the benefits of imposing a monthly payment are distributed broadly. \hl{TuT benefits are particularly large for XXX CHARACTERISTICS, and ToT benefits for those with XXX.} 
...
\todo[inline]{Need a sentence saying what the results are: at least such and such percent benefit from forced commitment}
...
We now show how our experimental design, henceforth the ``controlled choice design,'' combined with the exclusion restrictions from \eqref{eq:exclusion0} and \eqref{eq:exclution1} can be used to point identify a number of interesting and economically-relevant causal quantities without the need for additional structural restrictions.
