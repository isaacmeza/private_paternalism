...
Our estimate for $\beta_2$ is 2.38 with a one-sided heteroskedasticity-robust (HC3) of 0.42.
...
The \cite{huber_mellace} bounds for the TOT \& TUT APR are respectively:  $[-119, 122]$, and $[-4.2, 24.6]$.
