...
\begin{center}
\scriptsize{\input{./Tables/mechanism1_pres.tex}}
\end{center}
\end{table}
\vfill
...
\only<4>{  
    ...
    \begin{itemize}
    \item   We estimate the TuT conditional on $X_i=1$ or $X_i=1$ (say $X_i= PB_i$ or $=Confidence_i$) and see which subppulations have larger TuT.
