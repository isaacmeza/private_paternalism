...
*Generate CI (95%)	
forvalues i = 2/7 {	
	gen hi_p`i' = beta_p`i' + ci_p`i'
	gen lo_p`i' = beta_p`i' - ci_p`i'
	
	twoway rarea hi_p`i' lo_p`i' days, color(gs10)  || line beta_p`i' days, lwidth(thick) lpattern(solid) lcolor(black) || line zero days , lpattern(solid) lcolor(navy) ///
